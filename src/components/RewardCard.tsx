  ...
  return (
    <div
      className={cn(
        ...
        !canAfford && !isClaimed && "bg-card border-border"
      )}
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <h3 className="font-medium text-[13px]">{reward.name}</h3>
            {reward.isMilestone && (
          ...
          {!isClaimed && (
            <div className="mt-2 space-y-1">
              <div className="h-1.5 rounded-full bg-white/[0.06] overflow-hidden">
                <div
                  className="h-full rounded-full bg-gold transition-all duration-[600ms]"
